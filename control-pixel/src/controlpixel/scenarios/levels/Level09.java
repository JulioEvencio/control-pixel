...
public class Level09 extends Scenario {
	...
	protected void setStrings() {
		super.texts.add(new TextRender(StringLevel.LEVEL_09.getValue(), 25, 25, CustomColors.WHITE, super.game.getRender()));
	}

	@Override
	protected Scenario nextLevel() {
		Util.getSave().setLevel10(true);
